...
export const defaultContent: SiteContent = {
  header: {
    ...
    navItems: [
      ...
      { name: { zh: '新品', en: 'New Arrivals' }, href: '/new-arrivals', linkType:'internal' },
      { name: { zh: '全部商品', en: 'All Products' }, href: '/products', linkType:'internal' },
      { name: { zh: '工厂', en: 'Factory' }, href: '/factory', linkType:'internal' },
      { name: { zh: '常见问题', en: 'FAQ' }, href: '/faq', linkType:'internal' },
    ],
  },
  home: {
    carousel: {
      ...
      items: [
        {
          ...
          avatar: '/images/products/product4.jpg',
        },
        {
          id: 2,
          ...
          avatar: '/images/products/product3.jpg',
        },
        {
          id: 3,
          ...
          avatar: '/images/products/product1.jpg',
        },
      ],
    },
    featuredProducts: {
    ...
    linkGroups: [
      {
        title: { zh: '购物', en: 'Shop' },
        links: [
          { name: { zh: '新品上市', en: 'New Arrivals' }, href: '/new-arrivals', linkType:'internal' },
          { name: { zh: '全部商品', en: 'All Products' }, href: '/products', linkType:'internal' },
          { name: { zh: '热销推荐', en: 'Best Sellers' }, href: '#', linkType:'internal' },
        ],
      },
      {
        title: { zh: '帮助', en: 'Support' },
        links: [
          { name: { zh: '尺码指南', en: 'Size Guide' }, href: '#' , linkType:'internal'},
          { name: { zh: '配送说明', en: 'Shipping Info' }, href: '#' , linkType:'internal'},
          { name: { zh: '退换政策', en: 'Return Policy' }, href: '#' , linkType:'internal'},
          { name: { zh: '常见问题', en: 'FAQ' }, href: '/faq' , linkType:'internal'},
        ],
      },
      {
        ...
        links: [
          { name: { zh: '关于我们', en: 'About Us' }, href: '#', linkType: 'internal' },
          { name: { zh: '工厂介绍', en: 'Our Factory' }, href: '/factory', linkType: 'internal' },
          { name: { zh: '联系我们', en: 'Contact Us' }, href: '#', linkType: 'internal' },
        ],
      },
    ],
